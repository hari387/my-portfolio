...
pretty: node_modules
	$(PRETTIER) --write portfolio/src/main/blog/*.{html,css}
	find portfolio/src/main/java -iname *.java | xargs $(CLANG_FORMAT) -i
	find portfolio/src/main/blog -iname *.js | xargs $(CLANG_FORMAT) -i

validate: node_modules
	$(HTML_VALIDATE) portfolio/src/main/blog/*.html
	$(CSS_VALIDATOR) portfolio/src/main/blog/assets/css/*.css
	$(ESLINT) portfolio/src/main/blog/*.js
